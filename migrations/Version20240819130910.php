 ...
 */
final class Version20240819130910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD user_id INT NOT NULL, ADD trick_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE trick ADD category_id INT DEFAULT NULL, ADD user_id INT NOT NULL');
